...
def main():
    ...
    if continuar != "sí" and continuar != "si":
        print("Okay, este programa se cerrará")
        return
        ...
        try:
            if opcion == "1":
                ...
                try:
                    ...
                    # Si pone otro caracter que no sea numérico, imprimirá lo siguiente:
                    print("Por favor, ingresa valores numéricos válidos.")
            elif opcion == "2":
                # Se escogió la opción dos, por lo tanto se calculará el valor de la cantidad de fichas que se ganaron
                ...
                # Se escogió la opción 3, por lo tanto se imprime el mensaje dado y se "rompe" el programa
                print("Juego finalizado, hasta pronto.")
                break
            else:
                # Cualquier valor que no sea 1-3, se detecta como error y imprime:
